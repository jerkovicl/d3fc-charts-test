...
@Component({
  selector: 'app-d3fc-chart',
  templateUrl: './d3fc-chart.component.html',
  styleUrls: ['./d3fc-chart.component.scss'],
})
export class D3fcChartComponent implements OnInit, AfterViewInit {
  @ViewChild('chart')
